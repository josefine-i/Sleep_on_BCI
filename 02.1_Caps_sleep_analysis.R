...
#read in acc data 
d1 <- read.csv( "/Users/capuchin_monkey/Documents/Sleep_on_BCI/Cap_sleep/DATA/Caps_full_night_and_day_data.csv" )
unique(d1$tag)
class(d1)
...
# cleans the data to the sampling months 
## CAREFUL: with BCI'23 these are different 
...
write.csv( sleep_per, '/Users/capuchin_monkey/Documents/Sleep_on_BCI/Cap_sleep/DATA/sleep_per425.csv', row.names = F )
write.csv( full_dat, '/Users/capuchin_monkey/Documents/Sleep_on_BCI/Cap_sleep/DATA/full_dat425.csv', row.names = F )
write.csv( sleep_per_nona, '/Users/capuchin_monkey/Documents/Sleep_on_BCI/Cap_sleep/DATA/sleep_per_nona425.csv', row.names = F )
