...
species="Potos flavus"  # Change species to the species you will be working on assuming multiple species are in the dataframe
...
acc_dat$day <- lubridate::date( acc_dat$local_timestamp) #kinkajous are nocturnal 
...
write.csv(acc_dat2, "/Users/capuchin_monkey/Documents/Sleep_on_BCI/Kinkajou_sleep/DATA/Kinkajou_full_night_and_day_data_BCI23.csv", row.names = F) #saves the vedba 
head( acc_dat2 )
write.csv(d3, "/Users/capuchin_monkey/Documents/Sleep_on_BCI/Kinkajou_sleep/DATA/Kinkajou_downsample_ACC_BCI23.csv", row.names = F) #saves downsampled ACC
