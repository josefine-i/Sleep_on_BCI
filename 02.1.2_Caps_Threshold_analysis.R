...
#median
median(sleep_per_nona$SPT)
#std 
std.error(sleep_per_nona$SPT)
#sd
sd(sleep_per_nona$SPT)
#histogram to see distribution
hist(sleep_per_nona$SPT, breaks = 100) 
...
#median
median(sleep_per_nona$TST)
#std 
std.error(sleep_per_nona$TST)
#sd
sd(sleep_per_nona$TST)
#histogram to see distribution
hist(sleep_per_nona$TST, breaks = 100) 


### wake bouts ###

#mean
mean(sleep_per_nona$wake_bouts)
#median
median(sleep_per_nona$wake_bouts)
#std 
std.error(sleep_per_nona$wake_bouts)
#sd
sd(sleep_per_nona$wake_bouts)
#histogram to see distribution
hist(sleep_per_nona$wake_bouts, breaks = 100) 
...
sleep_one <- full_dat
sleep_one = sleep_one[which(sleep_one$night == "2015-12-22" & sleep_one$tag == "Olga_4657"),]
